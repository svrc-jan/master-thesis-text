...
\DeclareMathOperator{\outdeg}{d_{out}}
...
{   
    ...
    \lstset{
        ...
        keywords={,input, output, return, datatype, function, is, in, if, else, foreach, while, for, begin, end, not,} %add the keywords you want, or load a language as Rubens explains in his comment above.
