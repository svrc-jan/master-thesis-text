...
Tato práce se zabývá problémem dispečerského řízení vlaků (TDP) a návrhem heuristiky schopné rozhodování v reálném čase pro komplexní železniční sítě. Naše metoda využívá přístup shora dolů pro rozhodování o trasování, motivovaný strukturní analýzou instancí, včetně bezpečnostních hledisek, a formulací pomocí cest a cyklů pro řešení konfliktů, což odstraňuje nutnost používat Big-M omezení.
