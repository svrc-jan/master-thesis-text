...
Tato práce se zabývá problémem dispečerského řízení vlaků (TDP) a návrhem heuristiky schopné rozhodování pro komplexní železniční sítě v reálném čase. Naše metoda využívá přístup shora dolů pro rozhodování o trasování, motivovaný strukturní analýzou instancí, včetně bezpečnostních hledisek, a formulací pomocí cest a cyklů pro řešení konfliktů, což odstraňuje nutnost používat omezení s velkým M.
