...
\begin{enumerate}
	...
	\item {\emph{Theoretical background}} - basic theory necessary for~the description of~the solutions. The main focus is on~graph topology and~the use of~alternative and~disjunctive graphs for~scheduling models.
